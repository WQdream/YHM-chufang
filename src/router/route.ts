...
export const dynamicRoutes: Array<RouteRecordRaw> = [
	{
		...
		children: [
...

			{
				...
				redirect: '/cMedicine/prescriptManage',
				meta: {
					title: '中药管理',
					isLink: '',
					isHide: false,
				...
				children: [
					{
						path: '/cMedicine/prescriptManage',
						name: 'prescriptManage',
						component: () => import('/@/views/cMedicine/prescriptManage/index.vue'),
						meta: {
							title: '处方管理',
							isLink: '',
							isHide: false,
					...
					{
						path: '/cMedicine/zhongyaoManage',
						name: 'zhongyaoManage',
						component: () => import('/@/views/cMedicine/zhongyaoManage/index.vue'),
						meta: {
							title: '中药材管理',
							isLink: '',
							isHide: false,
			...
			},
			{
				...
				name: 'zhenjiuManage',
				component: () => import('/@/layout/routerView/parent.vue'),
				redirect: '/zhenjiuManage/prescriptManage',
				meta: {
					title: '针灸管理',
					isLink: '',
					isHide: false,
				...
				children: [
					{
						path: '/zhenjiuManage/useNeedleManage',
						name: 'useNeedleManage',
						component: () => import('/@/views/zhenjiuManage/useNeedleManage/index.vue'),
						meta: {
							title: '施针管理',
							isLink: '',
							isHide: false,
					...
					{
						path: '/zhenjiuManage/acupointManage',
						name: 'acupointManage',
						component: () => import('/@/views/zhenjiuManage/acupointManage/index.vue'),
						meta: {
							title: '穴位管理',
							isLink: '',
							isHide: false,
				...
				children: [
					{
						path: '/tools/main',
						name: 'main',
						component: () => import('/@/views/tools/main/index.vue'),
						meta: {
							title: '工具集',
							isLink: '',
							isHide: false,
					...
					},
					{
						...
						meta: {
							title: '腾讯元宝',
							isLink: 'https://yuanbao.tencent.com/chat/naQivTmsDa',
							isHide: false,
							isKeepAlive: true,
							isAffix: false,
							isIframe: true,
